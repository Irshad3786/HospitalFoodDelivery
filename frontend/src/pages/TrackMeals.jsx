    ...
    <div className='w-[100%] h-screen bg-[#00FFAA]'>
      <div>
            <div className='p-4 '>
                ...
                <h1 className='text-3xl font-outfit text-center p-5 font-semibold'>Track Meals</h1>
            </div>
          <div className=' flex justify-center items-center'>
            <div className='w-[80%] h-96 bg-white flex flex-col justify-center items-center gap-8 p-3 pt-12 pb-12 rounded-xl shadow-2xl'>
              <div className='w-[80%] h-44  rounded-md flex justify-center items-center '>
                <div className='w-[90%] md:w-[50%] h-[90%] bg-slate-900 rounded-lg flex justify-center items-center relative shadow-lg hover:bg-slate-600 cursor-pointer'>
                  <h1 className='font-roboto text-white text-xl flex justify-between items-center gap-4'>Morning <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 16 16"><path fill="#fff" d="m14 10l-1.58-1.18L13.2 7l-2-.23L11 4.8l-1.82.78L8 4L6.82 5.58L5 4.8l-.23 2L2.8 7l.78 1.82L2 10H0v1h16v-1zM4 10a4.143 4.143 0 0 1 3.993-4A4.143 4.143 0 0 1 12 9.993z"/></svg></h1>
              ...
              <div className='w-[80%] h-44  rounded-md flex justify-center items-center'>
                <div className='w-[90%] md:w-[50%] h-[90%] bg-slate-900 rounded-lg flex justify-center items-center relative shadow-lg hover:bg-slate-600 cursor-pointer'>
                  <h1 className='font-roboto text-white text-xl flex justify-between items-center gap-4'>Evening <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#FFFFFF" height="30px" width="30px" version="1.1" viewBox="0 0 512 512" enable-background="new 0 0 512 512">
                      <g>
