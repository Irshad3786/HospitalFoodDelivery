    ...
    <div className='w-[100%] h-screen'>
        <div className='w-[100%] h-20 bg-[#00FFAA] flex justify-center items-center gap-6 md:justify-start md:gap-[52%] sm:gap-[30%] '>
            ...
            <div className='flex gap-2'>
                <button className='flex justify-center items-center bg-white p-1 rounded-sm font-roboto hover:bg-slate-400 md:p-3 sm:p-3 sm:rounded-lg md:rounded-lg' onClick={Login}>
                ...
                <button className='flex justify-center items-center bg-white rounded-sm font-roboto hover:bg-slate-400 md:p-3 sm:p-3 sm:rounded-lg md:rounded-lg' onClick={CreateAccount}>
        ...
        {menu && (<div className=' absolute w-[100%] h-[20%] flex justify-center pl-20 md:pl-[42%] sm:pl-[45%]'>
            <div >
                <h1 className='border border-black p-2 hover:bg-[#00FFAA]'>Hospital Management login</h1>
                <h1 className='border border-black p-2 hover:bg-[#00FFAA]'>Pantry Login</h1>
                <h1 className='border border-black p-2 hover:bg-[#00FFAA]'>Delivery Login</h1>
            </div>
        </div>)}
        ...
        {menttwo &&(<div className='absolute w-[100%] h-[20%] flex justify-center pl-20 md:pl-[52%] sm:pl-[45%]'>
            <div >
                <h1 className='border border-black p-2 hover:bg-[#00FFAA]'>Hospital Management</h1>
                
            </div>
        </div>)}

        <div className='flex justify-center items-center w-[100%] h-[80%] pt-10 '>
