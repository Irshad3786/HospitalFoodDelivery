      ...
      <ToastContainer/>
        ...
        <Form onSubmit={Submit} >
            <div className='flex flex-col justify-center items-center gap-7 pt-28'>
              <input type="email" className='border border-black p-3 rounded-lg shadow-lg placeholder:font-roboto placeholder:font-semibold w-[80%] sm:w-[50%] md:w-[30%]' placeholder='Enter Email' value={Email}
